...
func handleConnection(p ParamsUpdate,conn net.Conn,accountInfoMap map[string]accountInfo,fromWhere whoAmI){
  ...
  connSuccessor,errSucc := net.Dial("tcp","localhost:8080")
  if errSucc != nil{
...
func logMessage(msg string){
  f, fileOpenError := os.OpenFile("../../log/serverLog", os.O_RDWR | os.O_CREATE | os.O_APPEND, 0666)
...
func startTheServer(){
  ...
  lnInter,errInter := net.Listen("tcp",":8073")
  if(errInter != nil){
